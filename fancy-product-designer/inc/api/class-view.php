			...
			foreach($options as $key => $value) {
				...
				if( fpd_not_empty($value) ) {
					...
					switch($key) {
						...
						break;
						case 'output_background_template':
							isset($options_arr['output']) ? $options_arr['output']['background_template'] = $value : $options_arr['output'] = array('background_template' => $value);
						break;
						case 'layouts':
