			...
			<table class="form-table">
				<tbody>
					<tr valign="top">
						...
						<td><input type="text" name="designs_parameter_colors" placeholder="<?php echo get_option('fpd_designs_parameter_colors'); ?>" value=""></td>
					</tr>
					<tr valign="top">
						<th scope="row"><label><?php _e('Color Link Group', 'radykal'); ?></label></th>
						<td><input type="text" name="designs_parameter_colorLinkGroup" placeholder="<?php echo get_option('fpd_designs_parameter_colorLinkGroup'); ?>" value=""></td>
					</tr>
					<tr valign="top">
		...
		<div data-id="custom-text-options">
			<table class="form-table">
				<tbody>
					...
					<tr valign="top">
						<th scope="row"><label><?php _e('Color Link Group', 'radykal'); ?></label></th>
						<td><input type="text" name="custom_texts_parameter_colorLinkGroup" placeholder="<?php echo get_option('fpd_custom_texts_parameter_colorLinkGroup'); ?>" value=""></td>
					</tr>
					<tr valign="top">
					...
					<tr valign="top">
						<th scope="row"><label><?php _e('Replace', 'radykal'); ?></label></th>
						<td><input type="text" name="custom_texts_parameter_replace" placeholder="<?php echo get_option('fpd_custom_texts_parameter_replace'); ?>" value=""></td>
					</tr>
					<tr valign="top">
						<th scope="row"><label><?php _e('Replace In All Views', 'radykal'); ?></label></th>
						<td>
