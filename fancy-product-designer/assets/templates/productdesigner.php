<div>
		...
		<div class="fpd-sub-panel">
			...
			<div class="fpd-panel-curved-text fpd-panel-content">
				...
				<div class="fpd-slider-group fpd-clearfix fpd-tooltip fpd-clear" data-defaulttext="Radius" title="toolbar.radius">
				    ...
				    <input class="fpd-slider-number fpd-number" value="80" step="1" min="0" max="200" data-control="curveRadius" />
			    </div>
	...
	<div class="fpd-element-toolbar fpd-visibility">
		...
		<div class="fpd-text-tools fpd-text-font-tools fpd-row fpd-clearfix">
			<span class="to-label" style="width:100px;float:left;">Change Font</span>
			<div class="fpd-tool-font-family fpd-dropdown fpd-search" style="float: right;">
		...
		<div class="fpd-common-tools fpd-row fpd-clearfix">
			<span class="to-label" style="width:100px;float:left;">Text Color</span>
			<div class="fpd-tool-fill fpd-tooltip" data-panel="fill" data-defaulttext="Fill" title="toolbar.fill" style="float: right;">
		...
		<!-- STROKE -->
		<div class="fpd-common-tools fpd-row fpd-clearfix">
			<span class="to-label" style="width:100px;float:left;">Outline</span>
			<div class="fpd-tool-text-stroke fpd-tooltip" data-panel="stroke" data-defaulttext="Stroke" title="toolbar.stroke" style="float: right;">
		...
		<!-- FONT SIZE -->
		<div class="fpd-common-tools fpd-row fpd-clearfix">
			<span class="to-label" style="width:100px;float:left;">Font Size</span>
			<div class="fpd-tool-text-size fpd-tooltip" data-defaulttext="Font Size" title="toolbar.font_size" style="float: right;">
		...
		<!-- LINE HEIGHT -->
		<div class="fpd-common-tools fpd-row fpd-clearfix">
			<span class="to-label" style="width:100px;float:left;">Line Height</span>
			<div class="fpd-tool-text-line-height fpd-tooltip" data-defaulttext="Line Height" title="toolbar.line_height" style="float: right;">
				<span class="fpd-icon-format-line-spacing"></span>
		...
		<!-- LETTER SPACING -->
		<div class="fpd-common-tools fpd-row fpd-clearfix">
			<span class="to-label" style="width:100px;float:left;">Letter Spacing</span>
			<div class="fpd-tool-text-letter-spacing fpd-tooltip" data-defaulttext="Letter Spacing" title="toolbar.letter_spacing" style="float: right;">
				<span class="fpd-icon-letter-spacing"></span>
		...
		<div class="fpd-common-tools fpd-row fpd-clearfix">
			<div class="fpd-tool-text-bold fpd-toggle fpd-tooltip smallBits" data-defaulttext="Bold" data-control="fontWeight" data-enabled="bold" data-disabled="normal" title="toolbar.bold" style="float: left;">
				<span class="fpd-icon-format-bold"></span>
			</div>
			<div class="fpd-tool-text-italic fpd-toggle fpd-tooltip smallBits" data-defaulttext="Italic" data-control="fontStyle" data-enabled="italic" data-disabled="normal" title="toolbar.italic" style="float: left;">
				<span class="fpd-icon-format-italic"></span>
			</div>
			<div class="fpd-tool-text-underline fpd-toggle fpd-tooltip smallBits" data-defaulttext="Underline" data-control="textDecoration" data-enabled="underline" data-disabled="normal" title="toolbar.underline" style="float: left;">
				<span class="fpd-icon-format-underline"></span>
			</div>
			<div class="fpd-tool-text-align fpd-dropdown smallBits">
	...
	<div class="fpd-modules">
		...
		<div class="fpd-module" data-module="text" data-moduleicon="fpd-icon-text-secondary" data-defaulttext="Add Text" data-title="modules.text">
			...
			<div class="fpd-load-tool-bar-dynamic"></div>
		</div>
